...
$$H_{out}=\lfloor \frac{H_{in} - kernel\_size[0] + 2 \times padding[0]}{strides[0]} +1  \rfloor$$
$$W_{out}=\lfloor \frac{W_{in} - kernel\_size[1] + 2 \times padding[1]}{strides[1]} +1  \rfloor$$    
